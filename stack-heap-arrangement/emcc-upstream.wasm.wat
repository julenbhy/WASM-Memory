(module
  ...
  (global $g0 (mut i32) (i32.const 5246704))
  ...
  (data $d0 (i32.const 1024) "-+   0X0x\00global const string\00dynamically (heap) allocated string\00stack-allocated (local) string\00next dynamically (heap) allocated\00(null)\00  in main()\00  in leaf()\00  in intermediate()\00    \09stack grows: %ld\0a\00    \09malloc has grown heap in: %ld but %d wasm requested\0a\00    \09stack at the beginning, addr :%p (%lu)\0a\00    %s, addr: %p (%lu)\0a\00    \09%s, addr: %p (%lu)\0a\00    stack value in leaf() function, addr: %p (%lu)\0a\00    argv[0]: %s, addr: %p (%lu)\0a\0a\00\00\00\00\00\00\19\00\0a\00\19\19\19\00\00\00\00\05\00\00\00\00\00\00\09\00\00\00\00\0b\00\00\00\00\00\00\00\00\19\00\11\0a\19\19\19\03\0a\07\00\01\00\09\0b\18\00\00\09\06\0b\00\00\0b\00\06\19\00\00\00\19\19\19")
  (data $d1 (i32.const 1553) "\0e\00\00\00\00\00\00\00\00\19\00\0a\0d\19\19\19\00\0d\00\00\02\00\09\0e\00\00\00\09\00\0e\00\00\0e")
  (data $d2 (i32.const 1611) "\0c")
  (data $d3 (i32.const 1623) "\13\00\00\00\00\13\00\00\00\00\09\0c\00\00\00\00\00\0c\00\00\0c")
  (data $d4 (i32.const 1669) "\10")
  (data $d5 (i32.const 1681) "\0f\00\00\00\04\0f\00\00\00\00\09\10\00\00\00\00\00\10\00\00\10")
  (data $d6 (i32.const 1727) "\12")
  (data $d7 (i32.const 1739) "\11\00\00\00\00\11\00\00\00\00\09\12\00\00\00\00\00\12\00\00\12\00\00\1a\00\00\00\1a\1a\1a")
  (data $d8 (i32.const 1794) "\1a\00\00\00\1a\1a\1a\00\00\00\00\00\00\09")
  (data $d9 (i32.const 1843) "\14")
  (data $d10 (i32.const 1855) "\17\00\00\00\00\17\00\00\00\00\09\14\00\00\00\00\00\14\00\00\14")
  (data $d11 (i32.const 1901) "\16")
  (data $d12 (i32.const 1913) "\15\00\00\00\00\15\00\00\00\00\09\16\00\00\00\00\00\16\00\00\16\00\000123456789ABCDEF")
  (data $d13 (i32.const 1952) "\0a\04\00\00\00\00\00\00\05")
  (data $d14 (i32.const 1972) "\02")
  (data $d15 (i32.const 1996) "\03\00\00\00\04\00\00\00X\08\00\00\00\04")
  (data $d16 (i32.const 2020) "\01")
  (data $d17 (i32.const 2036) "\ff\ff\ff\ff\0a")
  (data $d18 (i32.const 2104) "\a8\07\00\00\f0\0eP"))
